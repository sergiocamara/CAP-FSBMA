...
#include <stdbool.h>
#include <stdint.h>
/*Serial Program Square Matrix Multiplication*/

//rtdsc: to measure running time
uint64_t rtdsc() {
  uint32_t high, low;
...
/* Time measured for this matrix multiply operation */
...
int main(int argc, char *argv[]) {
  ...
  srand(getpid());
/* N is the size of the NxN square matrix */
  if (argc < 2) {
